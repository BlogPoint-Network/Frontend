...
export const recommendationsExamples: IPost[] = [
  {
    ...
    title:
      'Отправьтесь в путешествие уже сейчас! Отправьтесь в путешествие уже сейчас! Отправьтесь в путешествие уже сейчас! Отправьтесь в путешествие уже сейчас! Отправьтесь в путешествие уже сейчас!',
    content:
      'Отправьтесь с нами в незабываемые путешествия по разным уголкам мира! Мы покажем экзотические страны, уникальные места и невероятные истории из наших поездок.',
    time: '15:00',
    likes: 45,
    dislikes: 1,
    views: 1352,
